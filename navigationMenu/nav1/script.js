...
document.addEventListener("DOMContentLoaded", () => {
    console.debug('DOM loaded - script.js running');
    ...
    console.debug({ container, menuToggleBtn, menuOverlay, menuOverlayContainer, menuMediaWrapper, copyContainersLength: copyContainers.length, menuToggleLabel, hamburgerIcon });

    let isMenuOpen = false;
    let isAnimating = false;

    if (!menuToggleBtn) {
        console.error('menuToggleBtn not found — click handler not attached');
        return;
    }

    menuToggleBtn.addEventListener("click", (e) => {
        console.debug('menuToggleBtn clicked', e.target);
